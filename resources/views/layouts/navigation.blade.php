<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md border-b border-white/20 sticky top-0 z-50 shadow-sm">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user()->role === 'student')
                        <x-nav-link :href="route('home')" :active="request()->routeIs('home') || request()->routeIs('menus.*')">
                            {{ __('Home') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(Auth::user()->role === 'student')
                <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home') || request()->routeIs('menus.*')">
                    {{ __('Home') }}
